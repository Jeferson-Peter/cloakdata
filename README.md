...
| [`sequential_numeric`](examples/sequential_numeric.py)           | Sequential numeric pseudonyms with optional prefix (`prefix=None` → raw integers, default `"val"`)                                                                                                        | `["Alice","Bob","Alice"]` → `["val 1","val 2","val 1"]`                                                                                                                                |
| `sequential_alpha`                                               | Sequential alphabetic pseudonyms with optional prefix                                                                                                                                                     | `["Alice","Bob","Alice"]` → `["REFA","REFB","REFA"]`                                                                                                                                   |
